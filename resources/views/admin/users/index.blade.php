    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-lg p-4">
                ...
                <div class="text-2xl font-bold text-purple-400">{{ $admins }}</div>
            </div>
            <div class="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-lg p-4">
                <div class="text-xs text-gray-400 uppercase mb-1">Magasins</div>
                <div class="text-2xl font-bold text-blue-400">{{ $stores }}</div>
            </div>
            <div class="bg-gray-800/50 backdrop-blur border border-gray-700/50 rounded-lg p-4">
                <div class="text-xs text-gray-400 uppercase mb-1">Réparateurs</div>
                <div class="text-2xl font-bold text-green-400">{{ $repairers }}</div>
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-700/30">
                        @forelse($users as $user)
                            <tr class="hover:bg-gray-700/30 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-400">{{ $user['affiliation'] }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
