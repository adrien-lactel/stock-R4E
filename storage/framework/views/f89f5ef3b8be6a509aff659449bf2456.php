...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form method="POST" action="<?php echo e(route('admin.product-sheets.store')); ?>" id="productSheetForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="brand_temp" id="brand_select"
                            ...
                            <?php if(isset($selectedCategory) && isset($selectedCategory->brands)): ?>
                                <?php $__currentLoopData = $selectedCategory->brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($brand->id); ?>" <?php echo e(isset($selectedBrand) && $selectedBrand->id == $brand->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <select name="sub_category_temp" id="sub_category_select"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                required <?php echo e(isset($selectedBrand) ? '' : 'disabled'); ?>>
                            <option value="">-- Sélectionner une marque d'abord --</option>
                            <?php if(isset($selectedBrand) && isset($selectedBrand->subCategories)): ?>
                                <?php $__currentLoopData = $selectedBrand->subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                  placeholder="Description générale du produit..."><?php echo e(old('description')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="technical_specs" rows="4"
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                  placeholder="Processeur, RAM, stockage, connectivité..."><?php echo e(old('technical_specs')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="included_items" rows="3"
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                  placeholder="Câble HDMI, manette, câble d'alimentation..."><?php echo e(old('included_items')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="marketing_description" rows="3"
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                  placeholder="Texte commercial pour mettre en avant le produit..."><?php echo e(old('marketing_description')); ?></textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-4">
                        <?php $__currentLoopData = $mods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-start border rounded-lg p-3 hover:bg-gray-50 cursor-pointer">
                                <input type="checkbox" class="mod-checkbox rounded mt-1 mr-2" value="<?php echo e($mod->id); ?>" data-name="<?php echo e($mod->name); ?>" data-icon="<?php echo e($mod->icon ?? '🔧'); ?>">
                                <div class="flex-1">
        ...
        imageUpload.addEventListener('change', async function(e) {
            ...
            for (const file of files) {
                ...
                try {
                    ...
                    const uploadUrl = '<?php echo e(route("admin.product-sheets.upload-image")); ?>';
    ...
    if (romIdInput) {
        ...
        romIdInput.addEventListener('input', function() {
            ...
            debounceTimer = setTimeout(async () => {
                try {
                    const response = await fetch('<?php echo e(route("admin.product-sheets.autocomplete-rom")); ?>?q=' + encodeURIComponent(value));
        ...
        lookupBtn.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('<?php echo e(url("admin/product-sheets/lookup-rom")); ?>/' + encodeURIComponent(romId));
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\stock-R4E\resources\views/admin/product-sheets/create.blade.php ENDPATH**/ ?>