                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-750 transition">
                                ...
                                <td class="px-4 py-3">
                                    <div class="text-sm text-gray-400 max-w-md whitespace-pre-wrap"><?php echo e($req->description); ?></div>
                                </td>
                                <td class="px-4 py-3">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <button onclick="openEditModal(<?php echo e($req->id); ?>, '<?php echo e(addslashes($req->title)); ?>', '<?php echo e(addslashes($req->description)); ?>', '<?php echo e($req->type); ?>', '<?php echo e($req->priority); ?>')" 
                                                data-url="<?php echo e(route('admin.feature-requests.update', $req)); ?>"
