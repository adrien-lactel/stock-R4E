            ...
            <div class="space-y-2">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border rounded-lg" x-data="{ openCat: false }">
                        <div @click="openCat = !openCat; if(openCat && !$el.dataset.loaded) loadBrands(<?php echo e($category->id); ?>, $el)"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\stock-R4E\resources\views/admin/taxonomy/index-v2.blade.php ENDPATH**/ ?>