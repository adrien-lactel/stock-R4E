        ...
        <form method="POST" action="<?php echo e($sheet->exists ? route('admin.product-sheets.update', $sheet) : route('admin.product-sheets.store')); ?>">
                        ...
                        <div class="flex flex-wrap justify-center w-fit lg:w-full mx-auto" style="border: 3px solid #1f2937; border-radius: 12px; padding: 12px;">
                                ...
                                <?php if(count($articleImages) > 0): ?>
                                    <div x-data="{
                                        ...
                                        <div class="relative group">
                                            ...
                                            <div id="favorite-heart-display" class="<?php echo e($sheet->is_favorite ? '' : 'hidden'); ?> absolute top-2 left-2 bg-red-500/90 rounded-full p-2 shadow-lg">
                            ...
                            <div class="flex-1 order-4 lg:order-3" style="min-width: 256px;">
                                ...
                                <div class="flex items-center gap-2 mb-2">
                                    <?php if($sheet->exists): ?>
                                        <span class="text-xs font-mono bg-gray-200 text-gray-700 px-2 py-0.5 rounded">Fiche #<?php echo e($sheet->id); ?></span>
                                    <?php endif; ?>
                                    <h2 id="preview-name" class="text-2xl font-bold text-gray-800"><?php echo e($sheet->name ?? $selectedType->name); ?></h2>
                                </div>
                                ...
                                <?php if(isset($associatedConsole)): ?>
                                    <div class="space-y-1.5">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-mono bg-indigo-100 text-indigo-800 px-2 py-0.5 rounded">#<?php echo e($associatedConsole->id); ?></span>
                                        </div>
                            ...
                            <div class="flex flex-col w-64 shrink-0 order-3 lg:order-5 justify-between">
                                ...
                                <div style="background: #e5e7eb; padding: 10px 12px; margin-bottom: 8px; border-radius: 6px; height: 76px; box-sizing: border-box; display: flex; align-items: center; justify-content: center;">
                                    <div style="font-size: 14px; color: #111827; font-weight: 700; text-align: center;">
                                        <?php echo e($selectedType->isConsoleCategory() ? 'Visuels' : 'Images gameplay, cover et artwork'); ?>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3 p-3 rounded-lg border <?php echo e(old('is_favorite', $sheet->is_favorite) ? 'bg-red-50 border-red-200' : 'bg-gray-50 border-gray-200'); ?>">
                        <input type="checkbox" name="is_favorite" value="1" id="is_favorite_checkbox"
                               class="rounded border-gray-300 text-red-600 focus:ring-red-500"
                               <?php echo e(old('is_favorite', $sheet->is_favorite) ? 'checked' : ''); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                                  ...
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('description', $sheet->description ?? ($prefilledData['description'] ?? ''))); ?></textarea>
                    </div>
                            ...
                            <div class="bg-white rounded-lg p-3 border border-blue-200">
                                <div class="aspect-square bg-gray-100 rounded mb-2 flex items-center justify-center overflow-hidden">
                                    <?php if($selectedType->cover_image_url): ?>
                                        <img src="<?php echo e($selectedType->cover_image_url); ?>" class="w-full h-full object-cover cursor-pointer" alt="Cover" onclick="openZoomModal('<?php echo e($selectedType->cover_image_url); ?>')">
                                    <?php else: ?>
                                ...
                                <?php if($selectedType->cover_image_url): ?>
                                    <button type="button" onclick="useTaxonomyImageAsPrimary('<?php echo e($selectedType->cover_image_url); ?>')" 
                            ...
                            <div class="bg-white rounded-lg p-3 border border-blue-200">
                                <div class="aspect-square bg-gray-100 rounded mb-2 flex items-center justify-center overflow-hidden">
                                    <?php if($selectedType->logo_url): ?>
                                        <img src="<?php echo e($selectedType->logo_url); ?>" class="w-full h-full object-contain p-2 cursor-pointer" alt="Logo" onclick="openZoomModal('<?php echo e($selectedType->logo_url); ?>')">
                                    <?php else: ?>
                                        <span class="text-gray-400 text-xs">Aucune image</span>
                                    <?php endif; ?>
                                </div>
                                ...
                                <?php if($selectedType->logo_url): ?>
                                    <button type="button" onclick="useTaxonomyImageAsPrimary('<?php echo e($selectedType->logo_url); ?>')" 
                                            class="w-full text-xs bg-green-600 hover:bg-green-700 text-white px-2 py-1 rounded font-medium">
                                        ⭐ Utiliser
                                    </button>
                                <?php endif; ?>
                            ...
                            <div class="bg-white rounded-lg p-3 border border-blue-200">
                                <div class="aspect-square bg-gray-100 rounded mb-2 flex items-center justify-center overflow-hidden">
                                    <?php if($selectedType->screenshot1_url): ?>
                                        <img src="<?php echo e($selectedType->screenshot1_url); ?>" class="w-full h-full object-cover cursor-pointer" alt="Screenshot 1" onclick="openZoomModal('<?php echo e($selectedType->screenshot1_url); ?>')">
                                    <?php else: ?>
                                        <span class="text-gray-400 text-xs">Aucune image</span>
                                    <?php endif; ?>
                                </div>
                                ...
                                <?php if($selectedType->screenshot1_url): ?>
                                    <button type="button" onclick="useTaxonomyImageAsPrimary('<?php echo e($selectedType->screenshot1_url); ?>')" 
                                            class="w-full text-xs bg-green-600 hover:bg-green-700 text-white px-2 py-1 rounded font-medium">
                                        ⭐ Utiliser
                                    </button>
                                <?php endif; ?>
                            ...
                            <div class="bg-white rounded-lg p-3 border border-blue-200">
                                <div class="aspect-square bg-gray-100 rounded mb-2 flex items-center justify-center overflow-hidden">
                                    <?php if($selectedType->screenshot2_url): ?>
                                        <img src="<?php echo e($selectedType->screenshot2_url); ?>" class="w-full h-full object-cover cursor-pointer" alt="Screenshot 2" onclick="openZoomModal('<?php echo e($selectedType->screenshot2_url); ?>')">
                                    <?php else: ?>
                                        <span class="text-gray-400 text-xs">Aucune image</span>
                                    <?php endif; ?>
                                </div>
                                ...
                                <?php if($selectedType->screenshot2_url): ?>
                                    <button type="button" onclick="useTaxonomyImageAsPrimary('<?php echo e($selectedType->screenshot2_url); ?>')" 
                                            class="w-full text-xs bg-green-600 hover:bg-green-700 text-white px-2 py-1 rounded font-medium">
                                        ⭐ Utiliser
                                    </button>
                                <?php endif; ?>
...
?>
window.uploadedGameImages = <?php echo json_encode($jsImages); ?>;
window.primaryImageUrl = '<?php echo e($jsPrimaryImage); ?>';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let existingImages = <?php echo json_encode($jsImages ?? []); ?>;
    let mainImage = '<?php echo e($jsPrimaryImage ?? ''); ?>';
    let newImages = [];
...
<script>
    ...
    window.openTaxonomyImageEditorModal = function() {
        ...
        const romId = <?php echo json_encode(isset($associatedConsole) ? $associatedConsole->rom_id : null, 15, 512) ?>;
        const articleTypeName = <?php echo json_encode($selectedType->name ?? 'Article', 15, 512) ?>;
        const subCategoryName = <?php echo json_encode($selectedSubCategory->name ?? '', 15, 512) ?>;
        const categoryName = <?php echo json_encode($selectedCategory->name ?? '', 15, 512) ?>;
        const categoryId = <?php echo json_encode($selectedCategory->id ?? null, 15, 512) ?>;
        
        // Dossier de taxonomie calculé depuis PHP (utilise le mapping correct)
        const phpTaxonomyFolder = <?php echo json_encode(isset($selectedType) && method_exists($selectedType, 'getPlatformFolder') ? $selectedType->getPlatformFolder() : null, 512) ?>;
        ...
        // Images déjà connues depuis PHP
        let knownImages;
        if (isTaxonomyCategory) {
            // Pour consoles/cartes/accessoires : utiliser les images de taxonomie R2
            knownImages = {
                logo: <?php echo json_encode($selectedType->logo_url ?? null, 15, 512) ?>,
                display1: <?php echo json_encode($selectedType->console_display1_url ?? null, 15, 512) ?>,
                display2: <?php echo json_encode($selectedType->console_display2_url ?? null, 15, 512) ?>,
                display3: <?php echo json_encode($selectedType->console_display3_url ?? null, 15, 512) ?>
            };
        } else {
            // Pour les jeux vidéo : utiliser les anciennes images
            knownImages = {
                cover: <?php echo json_encode($selectedType->cover_image_url ?? null, 15, 512) ?>,
                logo: <?php echo json_encode($selectedType->logo_url ?? null, 15, 512) ?>,
                artwork: <?php echo json_encode($selectedType->screenshot2_url ?? null, 15, 512) ?>,
                gameplay: <?php echo json_encode($selectedType->screenshot1_url ?? null, 15, 512) ?>
            };
        }
    ...
    // Déterminer si c'est une catégorie avec images de taxonomie R2
    <?php
        $isTaxonomyCategory = isset($selectedCategory) && in_array($selectedCategory->id, [1, 12, 13]);
    ?>
    const knownTaxonomyImages = <?php echo json_encode($isTaxonomyCategory, 15, 512) ?> ? {
        logo: <?php echo json_encode($selectedType->logo_url ?? null, 15, 512) ?>,
        display1: <?php echo json_encode($selectedType->console_display1_url ?? null, 15, 512) ?>,
        display2: <?php echo json_encode($selectedType->console_display2_url ?? null, 15, 512) ?>,
        display3: <?php echo json_encode($selectedType->console_display3_url ?? null, 15, 512) ?>
    ...
    function renderTaxonomyImagesGrid(gridContainer, images, identifier, folder) {
        ...
        images.forEach(image => {
            ...
            <?php
                $isTaxonomyCat = isset($selectedCategory) && in_array($selectedCategory->id, [1, 12, 13]);
            ?>
            const isTaxonomyCat = <?php echo json_encode($isTaxonomyCat, 15, 512) ?>;
            if (isTaxonomyCat) {
                select.innerHTML = `
...
<script>
    ...
    window.openPublisherLogoModal = function() {
        ...
        <?php if(isset($selectedType) && $selectedType?->publisher_logo_url): ?>
