...
<div class="max-w-7xl mx-auto py-10 px-6" x-data="taxonomyManager()">
    ...
    <div class="bg-white shadow rounded-lg mb-6">
        ...
        <div x-show="activeTab === 'categories'" class="p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.taxonomy.category.store')); ?>" class="mb-6 flex gap-2">
                <?php echo csrf_field(); ?>
            ...
            <div class="space-y-2">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div x-show="!searchCategory || '<?php echo e(strtolower($category->name)); ?>'.includes(searchCategory.toLowerCase())"
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <form method="POST" action="<?php echo e(route('admin.taxonomy.category.update', $category)); ?>" class="flex gap-2">
                                    ...
                                    <input name="name" value="<?php echo e($category->name); ?>" 
                            ...
                            <div class="flex items-center gap-4 ml-4">
                                <span class="text-sm text-gray-500"><?php echo e($category->sub_categories_count ?? 0); ?> sous-cat.</span>
                                <?php if(($category->sub_categories_count ?? 0) === 0): ?>
                                    <form method="POST" action="<?php echo e(route('admin.taxonomy.category.destroy', $category)); ?>"
        ...
        <div x-show="activeTab === 'brands'" class="p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.taxonomy.brand.store')); ?>" class="mb-6 flex gap-2">
                <?php echo csrf_field(); ?>
            ...
            <div class="space-y-2">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $category->brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div x-show="!searchBrand || ('<?php echo e(strtolower($brand->name)); ?> <?php echo e(strtolower($category->name)); ?>').includes(searchBrand.toLowerCase())"
                             class="border rounded-lg p-3 hover:bg-gray-50 transition">
                            <div class="flex items-center justify-between">
                                <div class="flex-1">
                                    <form method="POST" action="<?php echo e(route('admin.taxonomy.brand.update', $brand)); ?>" class="flex gap-2">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
                                        <input name="name" value="<?php echo e($brand->name); ?>" 
                                               class="flex-1 rounded border-gray-300" required>
                                        <input type="hidden" name="article_category_id" value="<?php echo e($brand->article_category_id); ?>">
                                        <span class="text-sm text-gray-500 self-center"><?php echo e($category->name); ?></span>
                                        <button class="px-3 py-1 rounded bg-indigo-600 text-white text-sm hover:bg-indigo-700">💾</button>
                                    </form>
                                </div>
                                <div class="flex items-center gap-4 ml-4">
                                    <span class="text-sm text-gray-500"><?php echo e($brand->sub_categories_count ?? 0); ?> sous-cat.</span>
                                    <?php if(($brand->sub_categories_count ?? 0) === 0): ?>
                                        <form method="POST" action="<?php echo e(route('admin.taxonomy.brand.destroy', $brand)); ?>"
            ...
            <div class="space-y-2">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border rounded-lg" x-data="{ openCat: false }">
                        ...
                        <div @click="openCat = !openCat; if(openCat && !$el.dataset.loaded) loadBrandsTree(<?php echo e($category->id); ?>, $el)"
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-gray-500">(<?php echo e($category->brands->count()); ?> marques)</span>
                            </div>
                        </div>
                    ...
                    container.innerHTML = data.subcategories.map(sub => `
                        <div class="border rounded p-3 hover:bg-gray-50 transition">
                            <form method="POST" action="/admin/taxonomy/sub-category/${sub.id}" class="flex items-center gap-2" onsubmit="event.preventDefault(); updateSubcategory(${sub.id}, this)">
                                <input type="hidden" name="_token" value="${document.querySelector('meta[name="csrf-token"]')?.content || '<?php echo e(csrf_token()); ?>'}">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\stock-R4E\resources\views/admin/taxonomy/index-v3.blade.php ENDPATH**/ ?>