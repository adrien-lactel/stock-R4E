    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-3">
            <?php if($console->productSheet): ?>
                <a href="<?php echo e(route('admin.product-sheets.edit', $console->productSheet->id)); ?>"
                   class="px-4 py-2 rounded bg-blue-600 text-white hover:bg-blue-700 transition-colors flex items-center gap-2">
