            ...
            <div>
                ...
                <select id="category_select" name="category_temp" class="w-full rounded-md border-gray-300">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($category->id); ?>" <?php if($selectedType && $selectedType->subCategory->category->id == $category->id): echo 'selected'; endif; ?>>
    ...
    <?php if($selectedType): ?>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <h2 class="text-lg font-semibold text-gray-800 mb-4">
                Images existantes (<?php echo e(count($images)); ?>)
            </h2>
