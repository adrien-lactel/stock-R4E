...
<head>
    ...
    <title>Éditer <?php echo e($publisher->name); ?></title>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js']); ?>
</head>
<body class="bg-gray-50 p-6">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-6">
        <h1 class="text-2xl font-bold mb-6">Éditer : <?php echo e($publisher->name); ?></h1>
        
        <form action="<?php echo e(route('admin.publishers.update', $publisher)); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Nom</label>
                <input type="text" name="name" value="<?php echo e($publisher->name); ?>" 
            ...
            <div>
                ...
                <div id="dropzone" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-500 transition-colors cursor-pointer">
                    <div id="drop-preview">
                        ...
                        <img id="logo-preview" src="<?php echo e($publisher->logo_url); ?>" alt="<?php echo e($publisher->name); ?>" class="h-32 mx-auto mb-3">
                        <?php else: ?>
                ...
                <input type="hidden" name="logo" id="logo-path" value="<?php echo e($publisher->logo); ?>">
            ...
            <div>
                ...
                <textarea name="description" rows="3" 
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e($publisher->description); ?></textarea>
            </div>
    ...
    function uploadFile(file) {
        ...
        formData.append('publisher_id', '<?php echo e($publisher->id); ?>');
        formData.append('_token', '<?php echo e(csrf_token()); ?>');
        
        uploadProgress.classList.remove('hidden');
        
        fetch('<?php echo e(route('admin.publishers.upload-logo')); ?>', {
            method: 'POST',
            body: formData
        })
            ...
            if (data.success) {
                ...
                if (window.parent !== window) {
                    window.parent.postMessage({
                        ...
                        publisherId: '<?php echo e($publisher->id); ?>',
                        publisherName: '<?php echo e($publisher->name); ?>',
...
<?php /**PATH C:\laragon\www\stock-R4E\resources\views/admin/publishers/edit.blade.php ENDPATH**/ ?>