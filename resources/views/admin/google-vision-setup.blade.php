...
php artisan cache:clear</pre>
        ...
        <div class="mb-6">
            ...
            <ol class="list-decimal list-inside text-gray-700 space-y-1 ml-4">
                <li>Retournez sur <a href="{{ route('admin.articles.create') }}" class="text-indigo-600 hover:underline">Créer un article</a></li>
        ...
        <div class="mt-8 flex gap-4">
            <a href="{{ route('admin.articles.create') }}" class="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 font-semibold">
